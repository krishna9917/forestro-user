...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_callkit_incoming_yoer/flutter_callkit_incoming_yoer.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/zego_uikit/zego_uikit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/zego_zim_audio/zego_zim_audio.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/zego_zimkit/zego_zimkit.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ZIMAudio/ZIMAudio.framework"
