...
class _CombinedDetailsViewState extends State<CombinedDetailsView> {
                  ...
                  return Column(
                    ...
                    children: [
                      Container(
                          color: const Color.fromARGB(181, 241, 235, 179),
                          child: DataRowWidget(
                              label: ' Planet ', value: item.name)),
                      DataRowWidget(
                          label: 'cusp', value: item.house.toString()),
                      DataRowWidget(
                        label: 'Sign',
                        value: item.zodiac,
                      ),
                      DataRowWidget(
                        label: 'Sign Lord',
                        value: item.pseudoRasiLord,
                      ),
                      DataRowWidget(
                          label: 'Star Lord', value: item.pseudoNakshatraLord),
                      DataRowWidget(label: 'Sub Lord', value: item.subLord),
  ...
  Widget _buildKpHouse() {
    return Obx(() {
      ...
      String currentDetail = navigationHistory[currentIndex];
      final mahadashaList =
