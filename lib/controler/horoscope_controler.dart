...
class HoroscopeControler extends GetxController {
  ...
  var horoscopeDataListen = HoroscopeModel().obs;
  ...
  Future<void> horoscopeData(String zodiac, String date) async {
    try {
      ...
      const url = 'https://api.vedicastroapi.com/v3-json/prediction/daily-moon';
  ...
  Future<void> horoscopeDataen(String zodiac, String date) async {
    try {
      isLoading.value = true;
      final Map<String, dynamic> queryParams = {
        'zodiac': zodiac,
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData != null) {
          horoscopeDataListen.value = HoroscopeModel.fromJson(responseData);
          // print(horoscopeDataList.value);
        }
      }
    } catch (e) {
